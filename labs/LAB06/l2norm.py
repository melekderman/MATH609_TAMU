...
def jacobi(A, x, b, tolerance, max_iterations):
    ...
    for k in range(max_iterations):
        ...
        Lnorm2 = np.linalg.norm(x - x_old, ord=2) / np.linalg.norm(x, ord=2)
        if Lnorm2 < tolerance or Lnorm2 > 500:
            break
...
print("d = 15, tol = 0.01")
print("LU :",LU_Solver(XXt1,yXt1))
print("Jacobi :", jacobi(XXt1, a1, yXt1, 0.01, 200))
print("Gauss-Seidel :", gauss_seidel(XXt1, a1, yXt1, 0.01, 200))
print("GD :", GD(XXt1, a1, yXt1, s1, 0.01, 200))

print("d = 15, tol = 0.0001")
print("Jacobi :", jacobi(XXt1, a1, yXt1, 0.0001, 200))
print("Gauss-Seidel :", gauss_seidel(XXt1, a1, yXt1, 0.0001, 200))
print("GD :", GD(XXt1, a1, yXt1, s1, 0.0001, 200))

print("d = 50, tol = 0.01")
print("LU: ",LU_Solver(XXt6,yXt6))
print("Jacobi:", jacobi(XXt6, a6, yXt6, 0.01, 200))
print("Gauss-Seidel :", gauss_seidel(XXt6, a6, yXt6, 0.01, 200))
print("GD :", GD(XXt6, a6, yXt6, s6, 0.01, 200))

print("d = 50, tol = 0.0001")
print("Jacobi :", jacobi(XXt6, a6, yXt6, 0.0001, 200))
print("Gauss-Seidel :", gauss_seidel(XXt6, a6, yXt6, 0.0001, 200))
print("GD :", GD(XXt6, a6, yXt6, s6, 0.0001, 200))
