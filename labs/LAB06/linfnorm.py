...
def jacobi(A, x, b, tolerance, max_iterations):
    ...
    for k in range(max_iterations):
        ...
        LnormInf = np.linalg.norm(x - x_old, ord=np.inf) / np.linalg.norm(x, ord=np.inf)  
        if LnormInf < tolerance or LnormInf > 500:
            break
...
print(jacobi(XXt1, a1, yXt1, 0.01, 200))
print(gauss_seidel(XXt1, a1, yXt1, 0.01, 200))
print(GD(XXt1, a1, yXt1, s1, 0.01, 200))

print("d = 15, tol = 0.0001")
print(jacobi(XXt1, a1, yXt1, 0.0001, 200))
print(gauss_seidel(XXt1, a1, yXt1, 0.0001, 200))
print(GD(XXt1, a1, yXt1, s1, 0.0001, 200))

print("d = 50, tol = 0.01")
print("LU 50: ",LU_Solver(XXt6,yXt6))
print(jacobi(XXt6, a6, yXt6, 0.01, 200))
print( gauss_seidel(XXt6, a6, yXt6, 0.01, 200))
print( GD(XXt6, a6, yXt6, s6, 0.01, 200))

print("d = 50, tol = 0.0001")
print(jacobi(XXt6, a6, yXt6, 0.0001, 200))
print(gauss_seidel(XXt6, a6, yXt6, 0.0001, 200))
print(GD(XXt6, a6, yXt6, s6, 0.0001, 200))